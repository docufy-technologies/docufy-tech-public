...
export default function WhyDocufyTechSection() {
  return (
    <section
      id="why-docufy-tech-section"
      class="min-h-screen relative max-w-screen"
    >
      <h1 class="text-center uppercase max-sm:text-2xl text-balance">
        The Values Docufy Tech Provides
      </h1>
      <div class="py-16">
        <div class="mx-auto max-w-3xl lg:max-w-5xl px-6">
          <div class="relative z-5 grid grid-cols-6 gap-3">
            <Card class="relative col-span-full flex overflow-hidden lg:col-span-2">
              <CardContent class="relative m-auto size-fit pt-6 flex flex-col items-center justify-center">
                <div class="relative flex h-24 w-56 items-center my-12">
                  <GhoshamajaLine class="absolute inset-0 size-full" />
                  <h2 class="mx-auto block w-fit text-lg font-semibold">
                    100% Ownership
                  </h2>
                </div>
                <p class="text-center">
                  You receive the complete source code and handoff materials, so
                  your team can maintain, extend, and own it without dependency.
                </p>
              </CardContent>
            </Card>
            <Card class="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent class="pt-6">
                <div class="relative mx-auto flex aspect-square size-20 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border my-10">
                  <IconFingerprintOff class="m-auto h-fit w-14" />
                </div>
                <div class="relative z-5 mt-6 space-y-2 text-center">
                  <h2 class="group-hover:text-secondary-950 text-lg font-medium transition">
                    Security, Built In
                  </h2>
            ...
            <Card class="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent class="pt-6">
                <div class="pt-6 lg:px-6">
                  <svg
                    class="dark:text-muted-foreground w-full"
                    viewBox="0 0 386 123"
                    fill="none"
                ...
                <div class="relative z-5 mt-14 space-y-2 text-center">
                  <h2 class="text-lg font-medium transition">
                    Delivery You Can Trust
                  </h2>
                  <p class="text-foreground">
                    Scope, expectations, and timelines stay aligned, so delivery
                    feels predictable, fair, and low-drama.
                  </p>
                </div>
              </CardContent>
            </Card>
            <Card class="relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent class="grid pt-6 sm:grid-cols-2">
                <div class="relative z-5 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div class="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border">
                    <IconSearch class="m-auto size-5" stroke-width={1} />
                  </div>
                  <div class="space-y-2">
                    <h2 class="group-hover:text-secondary-950 text-lg font-medium transition">
                ...
                <div class="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6">
                  <div class="absolute left-3 top-2 flex gap-1">
                    <span class="block size-2 rounded-full border"></span>
                    <span class="block size-2 rounded-full border"></span>
                    <span class="block size-2 rounded-full border"></span>
                  </div>
                  <svg
            ...
            <Card class="relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent class="h-full pt-6">
                <div class="relative z-5 flex flex-col justify-between space-y-12 lg:space-y-6">
                  <div class="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border">
                    <IconCheck class="m-auto size-6" stroke-width={1} />
                  </div>
                  <div class="space-y-2">
                    <h2 class="text-lg font-medium transition">
                    ...
                    <p class="text-foreground">
                      ...
                      that value credibility, reliability, and minimal friction.
                    </p>
                  </div>
                </div>
              </CardContent>
